...
interface AplApi {
    ...
    @GET("hex/{hexes}")
    suspend fun getAircraftByHexes(@Path("hexes", encoded = true) hexes: String): HexesResponse
    ...
    @GET("squawk/{codes}")
    suspend fun getAircraftBySquawks(@Path("codes", encoded = true) codes: String): SquawksResponse
    ...
    @GET("squawk/{signs}")
    suspend fun getAircraftByCallsigns(@Path("signs", encoded = true) codes: String): CallsignsResponse

    @JsonClass(generateAdapter = true)
    data class Aircraft(
        @Json(name = "hex") override val hex: String,
        @Json(name = "type") val type: String?,
        @Json(name = "flight") override val flight: String?,
        @Json(name = "r") override val registration: String?,
        @Json(name = "t") val aircraftType: String?,
        ...
        @Json(name = "squawk") override val squawk: String?,
