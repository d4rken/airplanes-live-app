...
class WatchlistFragment : Fragment3(R.layout.watchlist_fragment) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ui.toolbar.apply {
            subtitle = resources.getQuantityString(R.plurals.watchlist_yours_x_active_msg, 0, 0)
        ...
        vm.state.observe2(ui) { state ->
            ...
            toolbar.subtitle = resources.getQuantityString(R.plurals.watchlist_yours_x_active_msg, 0, state.items.size)
        }
    ...
    private fun showAlertOptions() {
        MaterialAlertDialogBuilder(requireContext()).apply {
            setTitle(R.string.watchlist_add_title)

            val options = arrayOf(
                getString(R.string.watchlist_add_watch_type_label_flight),
                getString(R.string.watchlist_add_watch_type_label_aircraft),
                getString(R.string.watchlist_add_watch_type_label_squawk),
            )
